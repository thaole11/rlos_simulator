...
import { CreateLeadDetailsDto } from "../entities/ILeadDetailsEntity";
...
const LeadDetails = () => {
  ...
  const initialValues: CreateLeadDetailsDto = {
    customerType: "",
    customerFullName: "",
    dob: "",
    mobileCountry: "VN",
  ...
  const handleSubmit = async (values: CreateLeadDetailsDto) => {
    try {
  ...
  const handleReset = (values: CreateLeadDetailsDto, setFieldValue: any) => {
    // Reset to initial values
    (Object.keys(initialValues) as (keyof typeof initialValues)[]).forEach(
      (key) => {
  ...
  return (
    <div className="">
      <header className="p-4 border-b border-gray-300 grid grid-cols-3 text-base space-x-1">
        <div className="flex items-center">
          <h1 className="text-2xl font-bold">LEAD DETAILS</h1>
        </div>
        <div className="flex justify-between">
          <div className="flex items-center space-x-1">
            <div className="flex flex-col border border-gray-300 p-2 rounded-md bg-gray-200 text-green-600">
              <div className="">Thời gian thực hiện:</div>
              <div className="">00:00:00</div>
            </div>
            <div className="flex items-center">
              <div className="text-gray-500">Ngày trả lãi:</div>
              <div className="text-gray-500">23/05/2024</div>
            </div>
          </div>
          <div className="flex border border-gray-300 p-2 rounded-md bg-gray-200 text-white">
            <div className="">Thời gian còn lại:</div>
            <span className=""> 00:00:00</span>
          </div>
        </div>
        <div className="flex justify-between items-center">
          {/* Dropdown button named Chính sách xác định số tiền cấp tín dụng */}
          <button className="flex items-center bg-blue-300 text-white p-2 rounded-md h-fit">
            Chính sách xác định số tiền cấp tín dụng
          </button>

          <div className="flex items-center space-x-1">
            <div className="flex items-center bg-blue-700 text-white p-2 rounded-md">
              Hồ sơ chuyển tới Bước tiếp theo
            </div>
            <div className="flex items-center bg-blue-700 text-white p-2 rounded-md">
              Tác vụ khác
            </div>
            <div className="flex items-center bg-red-700 text-white p-2 rounded-md">
              <button>Thoát</button>
            </div>
          </div>
        </div>
